...
print(f"{days[hours.index(max(hours))]}")  # ✅ 토요일
...
print(
    f"max 점수: {result[-1]}점, min 점수: {result[0]}점"
...
print(f"총액: {total:,}원")
total = sum(price * qty for _, price, qty, in zip(*stocks))  # ✅ 총액: 21,000원
print(f"총액: {total:,}원")
